      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[92vh] overflow-y-auto rounded-3xl shadow-2xl"
          ...
          >
            ...
            <button
              onClick={cerrar}
              aria-label="Cerrar"
              className="absolute top-3 right-3 z-10 w-8 h-8 rounded-full bg-white/80 backdrop-blur flex items-center justify-center text-[#3b2a6b] hover:bg-white shadow-md transition"
            >
              <X size={17} />
            </button>
            ...
            {!verRecorrido ? (
              <div className="px-6 pt-6 pb-7 text-center">
                ...
                <motion.div
                  ...
                  className="relative mx-auto w-full rounded-2xl overflow-hidden shadow-lg ring-1 ring-amber-200"
                >
                  <img src="/carmen-eucaristia.jpg" alt="Nuestra Señora del Carmen" className="w-full object-cover" draggable={false} />
                </motion.div>
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center gap-2 px-6 py-3 rounded-full text-white text-sm font-semibold shadow-lg hover:scale-105 transition-transform"
              ...
              <div className="px-6 pt-6 pb-7">
                <img src="/carmen-recorrido.jpg" alt="Recorrido Día de la Virgen del Carmen" className="w-full rounded-2xl shadow-lg ring-1 ring-amber-200" draggable={false} />
                <button
