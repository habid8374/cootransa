        ...
        <div className="mt-14 pt-8 border-t border-white/5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="https://mintransporte.gov.co/" target="_blank" rel="noopener noreferrer" title="Ministerio de Transporte"
              className="flex items-center px-5 py-3 rounded-xl bg-white border border-white/10 hover:border-green-400/50 hover:shadow-lg transition-all">
              <img src="/logo-mintransporte.webp" alt="Ministerio de Transporte de Colombia" className="h-9 w-auto object-contain" loading="lazy" />
            </a>
            <a href="https://www.supertransporte.gov.co/" target="_blank" rel="noopener noreferrer" title="Superintendencia de Transporte"
              className="flex items-center px-5 py-3 rounded-xl bg-white border border-white/10 hover:border-green-400/50 hover:shadow-lg transition-all">
              <img src="/logo-supertransporte.webp" alt="Superintendencia de Transporte" className="h-10 w-auto object-contain" loading="lazy" />
            </a>
          </div>
        </div>
